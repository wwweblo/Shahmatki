  ...
  return (
    <div className="w-[90%] mx-auto py-8 px-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {hasChessBoard && (
          <div className="mt-8 w-3/4 md:w-1/3 flex flex-col mx-auto">
            <ChessboardDnDProvider>
              <div>
                <div
                  ...
                  className="rounded-xl border-1 border-neutral-600 bg-white/15"
                >
        ...
        <Button
          ...
          className="w-full sticky bottom-4 shadow-2xs"
        >
